      ...
      <div class="columns">
        <div class="column is-10">
          <b-field label="Search">
            <b-input v-model="search" @keydown.native.enter="updateList"></b-input>
          </b-field>
        </div>
    ...
    methods:{
      updateList(){
        if(this.search!=="" && this.field!==undefined){
          if(this.field==="datereported"){this.currentBuglist = this.searchDate(this.search)}
          else if(this.field.match("by")){this.currentBuglist = this.searchEmployee(this.search)}
          else if(this.field.match("severity")){this.currentBuglist =this.searchSeverity(this.search)}
          else if(this.field.match("status")){this.currentBuglist =this.searchStatus(this.search)}
          else if(this.field.match("reporttype")){this.currentBuglist =this.searchReportType(this.search)}
          else if(this.field.match("resolution")){this.currentBuglist =this.searchResolution(this.search)}
          else{this.currentBuglist = this.searchOther(this.search)}
        } else {
